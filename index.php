                ...
                <nav class="site-navigation text-right" role="navigation">
                  <div class="container">
                    ...
                    <ul class="site-menu js-clone-nav d-none d-lg-block">
                      ...
                      <li><a href="Hostel/signup.php">Sign Up</a></li>
                    </ul>
                  </div>
                </nav>
              </div>
      ...
      <div class="container">
        <div class="row align-items-center">
          <div class="col-md-6">
            ...
            <a class="text-white btn btn-outline-warning rounded-0 text-uppercase">Avail Now</a>
          </div>
          <div class="col-md-6">
          ...
          <div class="p-4">
            <div class="d-flex block-testimony">
              ...
              <div>
                ...
                <blockquote>&ldquo;Whats a nice hostel. It fulfill our all needs and we never see such hostel in the world before visiting it!&rdquo;</blockquote>
              </div>
            </div>
          </div>
          <div class="p-4">
            <div class="d-flex block-testimony">
              ...
              <div>
                ...
                <blockquote>&ldquo;Amazing, very Good! I have no any world to explain the beauity of this hostel and their all such hostels!&rdquo;</blockquote>
              </div>
            </div>
          </div>
          <div class="p-4">
