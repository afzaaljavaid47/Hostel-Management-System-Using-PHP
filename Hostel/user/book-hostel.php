...
$query="INSERT INTO `registration`(`hostel_name`, `roomno`, `seater`, `feespm`, `foodstatus`, `stayfrom`, `duration`, `cnic`, `firstName`, `middleName`, `lastName`, `gender`, `contactno`, `emailid`, `egycontactno`, `guardianName`, `guardianRelation`, `guardianContactno`, `corresAddress`, `corresCIty`, `corresState`, `corresPincode`, `pmntAddress`, `pmntCity`, `pmnatetState`, `pmntPincode`) VALUES ('$hname','$roomno','$seater','$feespm','$foodstatus','$stayfrom','$duration','$cnic','$fname','$mname','$lname','$gender','$contactno','$emailid','$emcntno','$gurname','$gurrelation','$gurcntno','$caddress','$ccity','$cstate','$cpincode','$paddress','$pcity','$pstate','$ppincode')";
$run=mysqli_query($con,$query);
if($run)
{
echo"<script>alert('Student Room Bookes Succssfully !');</script>";
$sql="UPDATE `rooms` SET `status`='booked' WHERE `hostel_name`='$hname' AND `room_no`='$roomno'";
mysqli_query($con,$sql);
}
else
{
echo"<script>alert('Student Room Not Bookes Succssfully ! Try Again');</script>";	
}
}
?>
...
<h2 class="page-title" style="padding-top: 9px;">Registration </h2>
...
<div class="col-sm-8">
<input type="text" name="hname" class="form-control" readonly="" value="<?php echo $data['Hostel_name']; ?>">
</div>
</div>
<div class="form-group">
...
<?php 
$hostl_name=$data['Hostel_name'];
$query ="SELECT * FROM `rooms` WHERE `hostel_name`='$hostl_name' AND `status`='free'";
$run=mysqli_query($con,$query);
...
else
{
	...
	<?php
echo '<script>alert("No any Room Available in this Hostel (Please Choose another hostel)");</script>';
echo '<h4 class="text-danger">No any Room Available in this Hostel (Please Choose another hostel) <a href="hostels.php">Choose Another Hostel</a></h4>';
} 
?>
...
<div class="col-sm-8">
<input type="text" name="seater" id="seater" value="<?php echo $count;?>" class="form-control"  >
</div>
</div>
...
<div class="col-sm-8">
<input type="text" name="cnic" id="regno"  class="form-control" value="<?php echo $row->cnic;?>" readonly >
</div>
</div>
