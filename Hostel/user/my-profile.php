...
$query="update  userRegistration set cnic=?,firstName=?,middleName=?,lastName=?,gender=?,contactNo=?,updationDate=? where id=?";
$stmt = $mysqli->prepare($query);
$rc=$stmt->bind_param('sssssisi',$cnic,$fname,$mname,$lname,$gender,$contactno,$udate,$aid);
$stmt->execute();
...
<div class="col-sm-8">
<input type="text" name="cnic" id="regno"  class="form-control" required="required" readonly="" value="<?php echo $row->cnic;?>">
</div>
</div>
