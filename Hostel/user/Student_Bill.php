  ...
  <tr>
  <td colspan="2"  class="font"><?php echo ucfirst($row['firstName']);?> <?php echo ucfirst($row['lastName']);?>'S <span class="font1"> Bill information &raquo;</span> </td>
  </tr>
  <tr>
  ...
  <tr>
  <td width="32%" valign="top" class="heading">Hostel Name : </td>

  <td class="comb-value1"><span class="comb-value"><?php echo $row['hostel_name'];?></span></td>
  </tr>
  <tr>
  ...
  <tr>
  <td width="12%" valign="top" class="heading">CNIC No: </td>
  <td class="comb-value1"><?php echo $row['cnic'];?></td>
  </tr>
