...
<div class="row">
<div class="col-md-12">
<h2 class="page-title" style="margin-top:4%">Manage Registred Customers</h2>
...
<?php	
$aid=$_SESSION['id'];
$ret="SELECT * FROM `registration` WHERE `hostel_name`='$hname'";
...
<td>
<a href="javascript:void(0);"  onClick="popUpWindow('http://localhost/hms/hostel/manager/full-profile.php?id=<?php echo $row->id;?>');" title="View Full Details"><i class="fa fa-desktop"></i></a>&nbsp;&nbsp;
