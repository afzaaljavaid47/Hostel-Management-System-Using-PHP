...
<div class="col-sm-8">
<input type="text"  name="hostel" disabled="" value="<?php echo $row->hostel_name;?>" class="form-control"><span class="help-block m-b-none">
Room Name can't be changed.</span> </div>
</div>
<div class="form-group">
<label class="col-sm-2 control-label">Seater  </label>
<div class="col-sm-8">
<select name="seater" class="form-control">
