...
<div class="col-sm-8">
<input type="text" name="hname" class="form-control" readonly="" value="<?php echo $hname;?>">
</div>
</div>
<div class="form-group">
...
<input class="btn btn-primary" type="submit" name="submit_room" value="Create Room ">
</div>
</div>
...
$sql="SELECT * FROM `rooms` WHERE `room_no`='$roomno' AND `hostel_name`='$hostel'";
$run=mysqli_query($con,$sql);
$row_cnt=mysqli_fetch_assoc($run);
if($row_cnt>0)
{
...
{
$query="INSERT INTO `rooms`(`hostel_name`, `seater`, `room_no`, `fees`, `posting_date`) VALUES ('$hostel','$seater','$roomno','$fees','$date')";
