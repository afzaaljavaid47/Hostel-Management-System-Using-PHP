...
<?php	
$aid=$_SESSION['id'];
$ret="SELECT * FROM `hostel` WHERE `status`='active'";
...
<a href="manage-hostels.php?del=<?php echo $row->Hostel_id;?>" onclick='return confirm("Do you want to delete");'><i class="fa fa-close"></i></a></td>
										</tr>
									<?php
$cnt=$cnt+1;
									 } ?>
